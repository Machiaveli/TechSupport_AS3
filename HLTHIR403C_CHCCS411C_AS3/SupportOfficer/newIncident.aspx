...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource2" EmptyDataText="There are no data records to display." GridLines="Horizontal" Width="100%" AllowPaging="True" AllowSorting="True" PageSize="5" style="text-align: center" DataKeyNames="IncidentID">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Incidents] WHERE [IncidentID] = @IncidentID" InsertCommand="INSERT INTO [Incidents] ([CustomerID], [ProductCode], [UserID], [DateOpened], [DateClosed], [Title], [Description], [JobStatus]) VALUES (@CustomerID, @ProductCode, @UserID, @DateOpened, @DateClosed, @Title, @Description, @JobStatus)" SelectCommand="SELECT Incidents.CustomerID, Incidents.ProductCode, Users.FirstName, Incidents.DateClosed, Incidents.Title, Incidents.Description, Incidents.JobStatus, Incidents.DateOpened, Incidents.IncidentID FROM Incidents INNER JOIN Users ON Incidents.UserID = Users.UserID" UpdateCommand="UPDATE [Incidents] SET [CustomerID] = @CustomerID, [ProductCode] = @ProductCode, [UserID] = @UserID, [DateOpened] = @DateOpened, [DateClosed] = @DateClosed, [Title] = @Title, [Description] = @Description, [JobStatus] = @JobStatus WHERE [IncidentID] = @IncidentID">
        <DeleteParameters>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="IncidentID" DataSourceID="customer" DefaultMode="Insert" GridLines="Horizontal" Height="50px" Width="100%" OnItemInserted="DetailsView1_ItemInserted">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="UserID" SortExpression="UserID">
                ...
                <InsertItemTemplate>
                    <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="users" DataTextField="FirstName" DataValueField="UserID" SelectedValue='<%# Bind("UserID") %>'>
                    </asp:DropDownList>
                </InsertItemTemplate>
                <ItemTemplate>
